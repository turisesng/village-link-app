      ...
      <Card className="w-full max-w-md text-center shadow-lg">
        <CardHeader className="space-y-4">
          ...
          <CardDescription className="text-md text-gray-700">
            Thank you for registering. Your application is currently under review by the estate administration team.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-md">
            <p className="text-sm text-blue-700 font-medium">
              **What happens next?** Access to the system is restricted until approval.
            </p>
          </div>
          <Button 
