...
import { LogOut, Megaphone, Briefcase, Clock } from "lucide-react";
import { toast } from "sonner";
import { supabase } from "@/integrations/supabase/client";
import { AnnouncementsView } from "@/components/shared/AnnouncementsView";
import { AvailableJobRequests } from "@/components/service-provider/AvailableJobRequests";
import { MyAcceptedJobs } from "@/components/service-provider/MyAcceptedJobs";
...
const ServiceProviderDashboard = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      setStats({
        availableJobs: available.count || 0,
    ...
    <div className="min-h-screen bg-background">
      <header className="border-b bg-card shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-primary">Service Provider Dashboard</h1>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground capitalize">
            {profile.service_category} - {profile.hours_of_operation || 'Set your hours of operation'}
          </p>
        </div>
        ...
        <Tabs defaultValue="available" className="space-y-4">
          ...
          <TabsContent value="available">
            <AvailableJobRequests onUpdate={fetchStats} serviceCategory={profile.service_category || ''} />
          </TabsContent>

          <TabsContent value="my-jobs">
            <MyAcceptedJobs onUpdate={fetchStats} />
          </TabsContent>
